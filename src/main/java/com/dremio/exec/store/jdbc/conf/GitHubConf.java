...
@SourceType(value = "GitHubARP", label = "GitHub",uiConfig = "github-layout.json")
public class GitHubConf extends AbstractArpConf<GitHubConf> {
  private static final String ARP_FILENAME = "arp/implementation/github-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.github.GitHubDriver";
